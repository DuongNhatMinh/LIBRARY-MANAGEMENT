...
{
    class LoanDTO : INotifyPropertyChanged
    {
        public string _Id;
        public string _User;
        ...
        public LoanDTO(string id, string user, string reader, int quantity, decimal loanpaid, decimal deposit, DateTime loandate, DateTime expdate)
        {
            this.Id = id;
            this.User = user;
            this.Reader = reader;
